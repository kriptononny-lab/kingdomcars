...
const VARIANTS = {
  primary: 'bg-gold text-black motion-safe:hover:bg-gold-light motion-safe:hover:shadow-[0_8px_24px_rgba(232,168,37,0.4)]',
  secondary: 'border-2 border-gold bg-transparent text-gold motion-safe:hover:bg-gold motion-safe:hover:text-black',
} as const;
...
type LinkProps = CommonProps & AnchorHTMLAttributes<HTMLAnchorElement> & { href: string; openCtaForm?: never };
type ButtonProps = CommonProps & ButtonHTMLAttributes<HTMLButtonElement> & { href?: never; openCtaForm?: boolean };
