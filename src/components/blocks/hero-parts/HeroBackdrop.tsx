  ...
  return (
    <>
      ...
      >
        ...
        />
        <div className="from-surface absolute right-0 bottom-0 left-0 h-[200px] bg-gradient-to-t to-transparent" />
      </div>
      <div
        aria-hidden="true"
        className="pointer-events-none absolute right-0 bottom-0 left-0 z-[1] h-[60%]"
      >
        <svg
        ...
        >
          ...
          <g fill="#E8A825" opacity="0.85">
            ...
            <circle cx="540" cy="400" r="2" />
            <circle cx="630" cy="340" r="2" />
            <circle cx="720" cy="380" r="2" />
            <circle cx="840" cy="320" r="2" />
            <circle cx="1075" cy="290" r="2" />
            <circle cx="1220" cy="320" r="2" />
            <circle cx="1420" cy="340" r="2" />
          </g>
        </svg>
      </div>
    </>
